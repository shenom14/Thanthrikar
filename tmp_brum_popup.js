...
document.addEventListener("DOMContentLoaded", () => {
    ...
    captureMicBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            chrome.tabs.create({
                ...
                isMicCapturing = true;
                captureMicBtn.innerText = "ΓÅ╣ Stop Mic Capture";
                document.getElementById("mic-status").innerText = "≡ƒÄÖ∩╕Å Microphone is live ΓÇö capturing audio...";
            });
        } catch (e) {
    ...
    function stopAudioCapture() {
        ...
        captureMicBtn.innerText = "≡ƒÄñ Capture Mic Audio";
